...
REM
REM Generated by Vivado on Sun Aug 03 14:05:44 +0300 2025
...
echo "xvhdl --incr --relax -prj tb_debounce_vhdl.prj"
call xvhdl  --incr --relax -prj tb_debounce_vhdl.prj -log xvhdl.log
