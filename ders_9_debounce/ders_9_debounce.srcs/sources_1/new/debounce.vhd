...
architecture Behavioral of debounce is
	...
	-- Butonun HIGH veya LOW sinyali ne kadar süre boyunca sabit kaldığını ölçer.Eğer timer_en = '1':Timer saymaya başlar. Eğer timer_en = '0':Timer sıfırlanır ve durur.
    ...
    -- Sayaç tamamlandığında 1 clock süresince '1' olan sinyal. Bu sinyal timer 1 ms bekledi ve sinyal değişmedi der veya 1 ms beklemedi der
    ...
    process (clk) begin
        if (rising_edge(clk)) then
            ...
            case state is
                ...
                -------------------------------------------------------------------------
                -- S_ZERO: Çıkış LOW (0) durumunda, giriş HIGH olursa geçiş doğrulaması başlar
