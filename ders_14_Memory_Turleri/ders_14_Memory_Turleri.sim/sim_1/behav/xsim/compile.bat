...
REM
REM Generated by Vivado on Thu Aug 07 17:03:31 +0300 2025
...
echo "xvhdl --incr --relax -prj BRAM_Uart_vhdl.prj"
call xvhdl  --incr --relax -prj BRAM_Uart_vhdl.prj -log xvhdl.log
